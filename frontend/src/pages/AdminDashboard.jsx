                ...
                <td className="p-2 border">
                  <button
                    className={`bg-red-500 text-white px-2 py-1 rounded hover:bg-red-600 ${
                      deletingUserId === u._id ? 'opacity-50 cursor-not-allowed' : ''
                    }`}
                  ...
                  <input
                    ...
                    onChange={(e) => {
                      const newMembers = e.target.checked
                        ...
                        : newProject.members.filter((m) => m !== u._id);
      ...
      <motion.div className="bg-white text-black shadow rounded p-4">
        ...
        <form onSubmit={createTask} className="grid gap-2 sm:grid-cols-2">
          ...
          <button
            ...
            className={`bg-green-600 text-white px-4 py-2 rounded mt-2 sm:col-span-2 ${
              submittingTask ? 'opacity-50 cursor-not-allowed' : ''
            }`}
          >
                ...
                <td className="p-2 border">
                  {editingTaskId === t._id ? (
                    <select
                      ...
                      onChange={(e) =>
                        setEditingTaskData({ ...editingTaskData, assignee: e.target.value })
                      }
                    >
                  ...
                  {editingTaskId === t._id ? (
                    ...
                    <>
                      ...
                      <button
                        ...
                        className={`bg-red-500 text-white px-2 py-1 rounded ${
                          deletingTaskId === t._id ? 'opacity-50 cursor-not-allowed' : ''
                        }`}
                      >
                        Delete
                      </button>
